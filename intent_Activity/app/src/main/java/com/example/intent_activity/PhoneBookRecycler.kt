...
import com.example.intent_activity.databinding.ActivityPhoneBookRecyclerViewBinding
...
class PhoneBookRecyclerActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding.phoneBookRecyclerview){
            ...
            inflater = LayoutInflater.from(this@PhoneBookRecyclerViewActivity),
            activity = this@PhoneBookRecyclerViewActivity)
